  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const formDataToSubmit = {
        ...
        siteCount: Number(formData.siteCount) || 0,
        userId: user.uid,
      ...
      const response = await fetch('https://api.perplexity.ai/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'You are a helpful assistant that provides company information. Return ONLY a JSON object with the following structure: {"address": string | null, "website": string | null, "decisionMaker": string | null, "mainActivity": string | null, "subActivities": string | null, "employeeCount": number | null, "siteCount": number | null}. Do not include any other text in your response.'
            },
            {
              role: 'user',
              content: `Find comprehensive business information for the company: ${formData.companyName}. Include address, website, decision maker (CEO), main activity, sub-activities, employee count, and number of locations. Return only JSON.`
            }
          ],
          temperature: 0.7,
          max_tokens: 500,
