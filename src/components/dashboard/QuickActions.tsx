    ...
    <>
      ...
      >
        <motion.button 
          ...
          className="flex items-center justify-between bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-lg px-4 py-3 group"
        >
        ...
        <Link to="/forms/new">
          <motion.div
            ...
            className="flex items-center justify-between bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-lg px-4 py-3 group cursor-pointer"
          >
