  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-teal-500 via-teal-600 to-teal-700">
        {/* Animated shapes */}
        <div className="absolute top-20 left-20 w-32 h-32 bg-teal-400/20 rounded-full blur-2xl" />
        <div className="absolute bottom-20 right-20 w-40 h-40 bg-teal-300/20 rounded-full blur-2xl" />
